...
const Test = () => {
  ...
  return (
    <div>
      <Link to="/cartdemo">Go to cart</Link>
        ...
        <Card sx={{ minWidth: 275 }}>
          <CardContent>
            ...
            <Typography variant="body2">
              Esta selección especial, da un aroma frutado verde intenso con
              notas de hierba recién cortada. Aceite de gran cuerpo, con un
              suave amargor y picor indicativos del mayor porcentaje de
              antioxidantes (Polifenoles), característicos de la aceituna en
              envero de más alto contenido en Ácido Oleico. Aceite de Oliva para
              experimentar con los platos de siempre.
              <br />
            </Typography>
            <br />
            <Typography
